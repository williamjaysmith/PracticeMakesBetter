...
i learned how to think about moving through nested arrays to find elements by index. I enjoyed this bit where row[i]would equal column[i] to apply a conditional diagnally through the matrix
